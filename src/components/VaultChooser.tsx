...
/** The app icon (glossy squircle + curled fox tail), matching the macOS dock icon. */
function AppLogo() {
  return (
    <svg
      width="72"
      ...
      className="mx-auto drop-shadow-[0_6px_16px_rgba(80,63,180,0.35)]"
    >
      <defs>
        ...
        <linearGradient id="logo-topSheen" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0" stopColor="#ffffff" stopOpacity="0.34" />
          <stop offset="0.5" stopColor="#ffffff" stopOpacity="0" />
        </linearGradient>
        <linearGradient id="logo-botShade" x1="0" y1="1" x2="0" y2="0">
          <stop offset="0" stopColor="#1e0f4a" stopOpacity="0.28" />
          <stop offset="0.45" stopColor="#1e0f4a" stopOpacity="0" />
        </linearGradient>
        <radialGradient id="logo-shine" cx="0.5" cy="0.26" r="0.72">
      ...
      <g clipPath="url(#logo-sq)">
        ...
        <rect x="104" y="104" width="816" height="816" fill="url(#logo-botShade)" />
        <ellipse cx="512" cy="300" rx="470" ry="330" fill="url(#logo-shine)" />
        <path d="M104 104 H920 V300 Q512 470 104 300 Z" fill="#ffffff" opacity="0.16" />
        <rect x="104" y="104" width="816" height="816" fill="url(#logo-topSheen)" />
      </g>
      <rect x="112" y="112" width="800" height="800" rx="180" fill="none" stroke="#ffffff" strokeOpacity="0.55" strokeWidth="16" />
